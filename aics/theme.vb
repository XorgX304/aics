...
''' <summary>
''' Flat UI Theme
''' Coder: iSynthesis (HF) // Blue version by: TRAGENALPHA
''' Version: 1.0.1
...
#Region " Variables"
    ...
    Friend _FlatColor As Color = Color.FromArgb(2, 187, 255)
...
#Region " Colors"
    ...
    Private _HeaderColor As Color = Color.FromArgb(45, 45, 45)
